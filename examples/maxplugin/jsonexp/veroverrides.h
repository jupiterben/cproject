...
#define MAXVER_INTERNALNAME "jsonexp\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "jsonexp.dle\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "JSON file exporter (plugin)\0"//should  be overidden on a per-dll level
